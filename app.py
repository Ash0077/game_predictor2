...
@app.route('/predict/la-liga/<ht>/<at>', methods=['GET'])
def PredictScore2(ht,at):
    select_league="la-liga"
    # folder='datasets/'+select_league+'/'
    # raw_data_1 = pd.read_csv(folder +'season-0809.csv')
    # raw_data_2 = pd.read_csv(folder +'season-0910.csv')
    # raw_data_3 = pd.read_csv(folder +'season-1011.csv')
...
@app.route('/predict/bundesliga/<ht>/<at>', methods=['GET'])
def PredictScore3(ht,at):
...
@app.route('/predict/ligue-1/<ht>/<at>', methods=['GET'])
def PredictScore4(ht,at):
    select_league="ligue-1"
    # folder='datasets/'+select_league+'/'
    # raw_data_1 = pd.read_csv(folder +'season-0809.csv')
    # raw_data_2 = pd.read_csv(folder +'season-0910.csv')
    # raw_data_3 = pd.read_csv(folder +'season-1011.csv')
...
@app.route('/predict/premier-league/<ht>/<at>', methods=['GET'])
def PredictScore5(ht,at):
    select_league="premier-league"
    # folder='datasets/'+select_league+'/'
    # raw_data_1 = pd.read_csv(folder +'season-0809.csv')
    # raw_data_2 = pd.read_csv(folder +'season-0910.csv')
    # raw_data_3 = pd.read_csv(folder +'season-1011.csv')
...
@app.route('/predict/serie-a/<ht>/<at>', methods=['GET'])
def PredictScore6(ht,at):
    select_league="serie-a"
    # folder='datasets/'+select_league+'/'
    # raw_data_1 = pd.read_csv(folder +'season-0809.csv')
    # raw_data_2 = pd.read_csv(folder +'season-0910.csv')
    # raw_data_3 = pd.read_csv(folder +'season-1011.csv')
